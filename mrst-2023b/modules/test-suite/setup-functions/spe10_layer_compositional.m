...
% Setup function six-component water-alternating gass injection
%
% SYNOPSIS:
%   setup = spe10_layer_compositional('pn1', pv1, ...)
%   setup = spe10_layer_compositional(fullSetup, 'pn1', pv1, ...)
%
% DESCRIPTION:
...
%}
    ...
    % Make model
    model = GenericOverallCompositionModel(G, rock, fluid,...
        eos.CompositionalMixture, 'water', true);
