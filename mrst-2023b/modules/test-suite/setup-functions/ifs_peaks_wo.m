...
% Setup function for an inverted five-spot with smoothly varying perm/poro
%
% SYNOPSIS:
%   setup = ifs_peaks_wo('pn1', pv1, ...)
%   setup = ifs_peaks_wo(fullSetup, 'pn1', pv1, ...)
%
% DESCRIPTION:
%   Setup of an inverted five-spot case with smoothly varying permeability
%   and porosity, generated by tiling MATLAB's peaks function. The
%   configurable parameters include:
%      'ncells' - number of cells in x/y direction (default: 51)
%      'tiles'  - number of tiles for peaks        (default: 1)
