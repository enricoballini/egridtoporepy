classdef SummarySelector < UIItem
    ...
    methods
        ...
        function s = SummarySelector(smry, varargin)
            opt = struct('Parent',          [], ...
            ...
            controls      = {{nameSelector, propSelector}, {leftButton, rightButton}, {regionSwitch}};
            controlLayout = {[.5, nan],[.5, nan], nan}; 
            ...
            [s.names, s.props, s.name2prop] = deal(names, props, name2prop);
