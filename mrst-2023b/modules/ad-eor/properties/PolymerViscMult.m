classdef PolymerViscMult < StateFunction
...
% model is used to compute the effective water viscosity.
    ...
    methods
        function gp = PolymerViscMult(model, varargin)
        ...
        function polyMult = evaluateOnDomain(prop, model, state)
            ...
            mixpar  = fluid.mixPar;
            polyMult = mult.^mixpar .* multMax.^(1-mixpar);           
        end
    end
end
