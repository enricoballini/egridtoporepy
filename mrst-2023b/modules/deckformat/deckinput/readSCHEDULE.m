...
%}
   ...
   ncomp = nan;
   if isfield(deck.RUNSPEC, 'COMPS'), ncomp = deck.RUNSPEC.COMPS; end
...
function control = defaultControl(varargin)
   ...
   if nargin > 0
      ...
      control.WELLSTRE = [control.WELLSTRE; varargin{1}.WELLSTRE];
      control.WINJGAS  = [control.WINJGAS; varargin{1}.WINJGAS];
