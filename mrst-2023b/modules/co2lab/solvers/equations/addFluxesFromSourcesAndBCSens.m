function [eqs, qBC, qRes, BCTocellMap, qSRC, srcCells, bcCells] = addFluxesFromSourcesAndBCSens(model, eqs, pressure, rho, mob, b, s, forces, permfac, dz)
...
%}
    ...
    if ~isempty(forces.bc)
        ...
        [qBC, BCTocellMap, bcCells, qRes] = getBoundaryConditionFluxesADSens(model, pressure, rho, mob, b, s, forces.bc, permfac, dz);
