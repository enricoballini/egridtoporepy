...
%   getFormationTopGrid        - Load the formation grid at a given coarsening level
%   getValuesSPE134891         - Undocumented Utility Function
%   interleave                 - Interleave the elements of two cell arrays
%   mapPlot                    - Plot a map of the 2D formation, with optional features.
%   selectedResultsMultiplot   - background variables can be: h|h_max|pressure|rs|sGmax|s|smax|totalCO2
