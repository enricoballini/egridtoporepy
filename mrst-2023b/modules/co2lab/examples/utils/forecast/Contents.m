...
%
% Files
%   colorizeCatchmentRegions   - Add catchment areas to current figure window
%   computeCaprockTemperature  - NB: returns value in Celsius, not Kelvin
%   computeHydrostaticPressure - Returns pressure in Pascals
